import svgPaths from "./svg-gro9vr7ihx";
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[39px] top-[569px] w-[294px]" data-name="Frame">
      <Frame />
    </div>
  );
}
...
function Cells() {
  return (
    <div className="absolute h-[76px] left-[8px] rounded-[10px] top-0 w-[294px]" data-name="cells">
      <TableCells1 />
      <TableCells2 />
      <Group />
    </div>
...
function Cells1() {
  return (
    <div className="absolute h-[76px] left-[8px] rounded-[10px] top-[76px] w-[294px]" data-name="cells">
      <TableCells3 />
      <TableCells4 />
      <Group1 />
    </div>
...
function Divider() {
  return (
    <div className="absolute h-0 left-[8px] top-[76px] w-[294px]" data-name="divider">
...
function Divider1() {
  return (
    <div className="absolute h-0 left-[8px] top-[152px] w-[294px]" data-name="divider">
      <div className="absolute inset-[-0.5px_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 294 1">
          <g id="divider">
            <path d="M0 0.5H294" id="Vector 2" stroke="var(--stroke-0, #0E0F0C)" strokeOpacity="0.121569" />
...
function CellsHover() {
  return (
    <div className="absolute bg-[rgba(22,51,0,0.03)] border border-[rgba(14,15,12,0.12)] border-dashed h-[76px] left-[8px] rounded-[16px] top-[156px] w-[294px]" data-name="cells - hover">
      <TableCells5 />
      <Icons3 />
      <TableCells6 />
    </div>
...
function Body() {
  return (
    <div className="absolute bg-white h-[304px] left-[8px] rounded-bl-[16px] rounded-br-[16px] top-[56px] w-[310px]" data-name="body">
      <Cells />
      <Cells1 />
      <Divider />
      <Divider1 />
...
function Bank() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="bank">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#454745] text-[12px] text-nowrap tracking-[0.12px]">
...
function Component() {
  return (
    <div className="absolute content-stretch flex flex-col items-end left-0 px-[16px] py-0 top-[296px] w-[326px]" data-name="$">
      <Bank />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0e0f0c] text-[24px] text-nowrap tracking-[-0.6px]">
...
function Example() {
  return (
    <div className="absolute bg-[rgba(22,51,0,0.08)] h-[368px] left-[24px] rounded-[24px] top-[180px] w-[326px]" data-name="example">
      <Header1 />
      <Body />
      <Component />
    </div>
